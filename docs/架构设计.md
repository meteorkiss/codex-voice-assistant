...
更新：2026-09-12。本文为从 0.6.12 逐步整理的目标设计，目录和接口示例不是已经完成的重构。0.6.13 已提取 TaskBinding；0.6.14 提取基础服务并统一版本；0.6.15 增加 PreferenceActions 和 CodexAdapter；0.6.16 提取 AudioOutput 管理合成、播放交接与资源清理；0.6.17 在 HandsFree 所有权内加入短时连续接话会话与 AEC 采集交接。完整发行和设备矩阵仍按计划推进。
